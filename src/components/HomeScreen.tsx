...
export const HomeScreen: React.FC<HomeScreenProps> = ({ onNewMatch, onOpenSettings }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-24 h-24 rounded-2xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.6)] border border-[#c2a278]/40">
      ...
      <p className="mt-1.5 text-xs font-bold tracking-[0.5em] text-[#e5c07b]/90">{t('home.subtitle')}</p>
